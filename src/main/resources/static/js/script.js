$(document).ready(function(){
  ...
  $(".category_btn").on('click', function(){
    ...
    //   $('.category_btn img').attr('src','<%= request.getContextPath() %>/images/close_btn.png');
      
    // } else {

    //   $('.category_btn img').attr('src','<%= request.getContextPath() %>/images/category_icon.png');
    // }
  });
  ...
  $('.play_btn').click(function(){
		...
		// video.attr('src', '<%= request.getContextPath() %>/images/video/video_01.mp4');
		video.get(0).play();
 ...
 if(matchMedia("screen and (max-width:768px)").matches){ 
  ...
  $('.banner_txt img').attr('src','<%= request.getContextPath() %>/images/banner_img_m.png');
  $('.ft_text br').remove();
 } ;
  // scroll plugin code
